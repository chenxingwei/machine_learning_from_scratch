...
We have previously stated the OLS loss function in ![linear regression](https://github.com/chenxingwei/machine_learning_from_scratch/edit/master/algorithm/1.linearRegression.md), following is the formula:
